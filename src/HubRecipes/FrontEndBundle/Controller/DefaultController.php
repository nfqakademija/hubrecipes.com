...
class DefaultController extends Controller
{
    public function indexAction()
    {
        ...
        $withIngredientsI = [];
        $withoutIngredientsI = [];
        $sour = rand(10000)/10000;
        $salty = rand(10000)/10000;
        $sweet = rand(10000)/10000;
        $spicy = rand(10000)/10000;
        $bitter = rand(10000)/10000;
        $savory = rand(10000)/10000;
        $time = rand(10000)/10000;
        $cuisine = '';
        $type = '';
        $start = 0;
